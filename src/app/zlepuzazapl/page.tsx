...
export default function UnnerfedPuzzlePlazaPage() {
  ...
  const initFlowPuzzle = () => {
    ...
    const puzzleString = '6000b0000090700000068000b10000000000003000005000000008000000000003000000040005700000020000000000000000000000000010000000000000000009000000000000040000002a0000000000a00000000000000'
